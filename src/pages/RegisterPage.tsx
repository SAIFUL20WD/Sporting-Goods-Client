...
const RegisterPage = () => {
	...
	const handleSubmit = async (e: FormEvent) => {
		...
		try {
			...
			dispatch(setUser({ user: res.data.data, token: null }));

			toast.success("Signed up successfully. Signin now", {
				id: toastId,
				duration: 2000,
			});
			navigate("/login");
				...
				<div className="flex flex-wrap items-center">
					<div className="hidden w-full xl:block xl:w-1/2">
						<div className="py-17.5 px-26 text-center">
							...
							<h3 className="text-3xl text-primary font-semibold uppercase">
								Hello! Welcome
							</h3>
